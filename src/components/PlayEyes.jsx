...
function PlayEyes() {
  ...
  return (
    <div className="w-full sm:h-screen h-50 sm:overflow-hidden ">
      <div
        data-scroll
        data-scroll-section
        data-scroll-speed="-.5"
        className="relative w-full h-[15rem] lg:h-full lg:bg-cover bg-no-repeat bg-contain bg-center bg-[url('https://i.ibb.co/vxfyP9Mm/Top-Viewbbcbv-1-1440x921.jpg')]"
      >
