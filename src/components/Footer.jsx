...
function Footer() {
  return (
    <div className="w-full h-full flex font-['Test_Founders_Grotesk_X_Condensed']">
      ...
      <div className="w-1/2 text-charcoal ">
        ...
        <div className="">
          ...
          <div className="flex justify-between">
            <div className="flex flex-col font-['Neue_Montreal'] mt-8 capitalize">
              {[
                "l:",
                "202-1965 W 4th Ave",
                "Vancouver, Canada",
          ...
          <div className="flex flex-col font-['Neue_Montreal']">
            {["E:", "hello@ochi.design"].map((item, index) => (
              <a
                key={index}
                className={` ${index === 1 && "mt-4"} ${index === 3 && "mt-4"}`}
              >
                {item}
              </a>
            ))}
